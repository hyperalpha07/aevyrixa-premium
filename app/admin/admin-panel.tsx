...
type AdminSoundCue = "click" | "hover" | "tab" | "success" | "warning";
  ...
  const play = useCallback(
    (cue: AdminSoundCue) => {
      ...
      try {
        ...
        const duration = cue === "warning" ? 0.16 : cue === "success" ? 0.18 : 0.075;
        oscillator.type = cue === "warning" ? "sawtooth" : "sine";
        oscillator.frequency.value = frequencies[cue];
        gain.gain.setValueAtTime(cue === "hover" ? 0.018 : 0.034, context.currentTime);
