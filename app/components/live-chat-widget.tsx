            ...
            <div className="flex flex-wrap gap-1.5 border-b border-white/[0.06] px-4 py-3">
              ...
              {(whatsappUrl || supportPhone) && (
                <button
                  ...
                  className="flex items-center gap-1 rounded-full border border-green-500/25 bg-green-500/[0.06] px-3 py-1.5 text-xs font-medium text-green-300/80 transition hover:border-green-500/40"
                >
                  <svg viewBox="0 0 24 24" className="h-3 w-3 fill-green-400" aria-hidden="true">
              ...
              <div className="border-t border-white/[0.08] px-4 py-3">
                ...
                <div className="flex items-end gap-2">
                  ...
                  <button
                    ...
                    className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-cyan-400/90 text-black transition hover:bg-cyan-300 disabled:opacity-40"
                  >
                    {sending ? (
