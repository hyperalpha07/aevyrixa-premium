      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/45">
            {shopLinks.map((link) => (
              <li key={link.label}>
                <Link href={link.href} className="transition hover:text-[#FFB3D1]">
                  {link.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-white/45">
            {supportLinks.map((link) => (
              <li key={link.label}>
                <Link href={link.href} className="transition hover:text-[#31E6D4]">
                  {link.label}
                </Link>
              </li>
            ))}
          ...
          <div className="mt-4 flex flex-wrap gap-2.5">
            ...
            {whatsappUrl && (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-[#25D366]/35 bg-[#25D366]/[0.08] text-[#25D366] transition hover:border-[#25D366]/60 hover:bg-[#25D366]/15"
              >
            ...
            {socialLinks.map((link) => (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/50 transition hover:border-[#FF4DB8]/35 hover:bg-[#FF4DB8]/[0.08] hover:text-[#FFB3D1]"
              >
                {link.label === "Facebook" && (
                  <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-hidden="true">
            ...
            {supportEmail && (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/50 transition hover:border-[#00D4C6]/35 hover:bg-[#00D4C6]/[0.08] hover:text-[#31E6D4]"
              >
