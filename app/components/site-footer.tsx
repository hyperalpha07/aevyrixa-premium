    ...
    <footer className="border-t border-white/10 bg-[#02040d] px-4 pb-24 pt-12 text-white sm:px-6 sm:pb-16">
      <div className="mx-auto grid max-w-7xl gap-8 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div>
          ...
          {brandTagline && (
            <p className="mt-4 line-clamp-2 text-sm leading-7 text-white/56">
              {brandTagline}
            </p>
          )}
        ...
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-2.5">
            ...
            {whatsappUrl && (
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full border border-[#25D366]/40 bg-[#25D366]/10 text-[#25D366] transition hover:border-[#25D366]/60 hover:bg-[#25D366]/20"
              >
          ...
          {supportEmail && (
            <p className="mt-3 text-xs text-white/40">{supportEmail}</p>
          )}
        </div>
      </div>
