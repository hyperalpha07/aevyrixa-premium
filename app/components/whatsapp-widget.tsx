...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      className={`fixed ${productDetailOffset} right-4 z-50 flex items-center gap-2 rounded-full border border-[#00D4C6]/30 bg-[#151024]/92 px-4 py-3 text-sm font-semibold text-white shadow-[0_4px_24px_rgba(0,212,198,0.18)] backdrop-blur-xl transition hover:-translate-y-0.5 hover:border-[#00D4C6]/50 hover:bg-[#211633] hover:shadow-[0_6px_28px_rgba(0,212,198,0.24)] md:bottom-8 sm:right-6`}
    >
