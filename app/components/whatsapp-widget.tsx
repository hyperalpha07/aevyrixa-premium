...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-white shadow-[0_4px_24px_rgba(37,211,102,0.40)] transition hover:-translate-y-0.5 hover:bg-[#22c35e] hover:shadow-[0_6px_28px_rgba(37,211,102,0.55)] sm:bottom-8 sm:right-6"
    >
